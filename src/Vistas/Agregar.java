...
private void limpiar(){
    ...
    private void initComponents() {
        ...
        cboxProducto.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Carne", "Verdura", "No perecible", "Marisco", "Bebidas", "Aderezo", "Especias" }));
        ...
        cboxTipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pollo", "Vacuno", "Cerdo", "Pescado", "Molusco", "Crustacio", "Arroz", "Pasta", "Bebida alcoholica", "Bebida gaseosa", "Bebida sin gas", "Bebidas calientes", "Salsas", "Liquidos?", "Aliños", " " }));
